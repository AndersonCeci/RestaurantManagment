            ...
            <td>
                <div id="menu_discDiv">
                    <p>
                        ...
                        potato fries or onion rings just 100Lek extra. Be sure to ask your server about our
                                        ...
                                        <table id="InLine">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    Lek<asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Price") %>'>0</asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
