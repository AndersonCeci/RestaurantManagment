            ...
            <td>
                ...
                <div style="float: right;">
                    <asp:Button ID="ViewMyReservations" runat="server" Text="View My Reservations" Style="border: solid 1px #ddd"
                        Height="40px" Width="200px" BackColor="#9DA4D6" ForeColor="Black" 
                    ...
                    <tr>
                        <td align="center">
                            <asp:Button ID="BtnViewAllAvailableTimes" runat="server" Text="View All Available Times"
                                BackColor="#00CC00" Style="border: solid 1px #ddd" Height="40px" Width="200px"
            ...
            <td valign="top" style="width: 50%">
                <table>
                    ...
                    <tr style="border-bottom: solid 1px #ddd">
                        ...
                        <td valign="top">
                            Time in:<br />
                            <asp:DropDownList ID="ddlTimeIn" Width="250px" BackColor="White" ForeColor="Black"
                            ...
                            <br />
                            Time out:<br />
                            <asp:DropDownList ID="ddlTimeOut" Width="250px" BackColor="White" ForeColor="Black"
                                Height="35px" runat="server">
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="DropDownList1" Width="250px" BackColor="White" ForeColor="Black"
                            ...
                            <div style="width: 450px">
                                <asp:Button ID="SubmitReservation" runat="server" Text="Submit" BackColor="#009933"
                                    Style="border: solid 1px #ddd" Height="40px" Width="200px" OnClick="SubmitReservation_Click" ForeColor="Black" />
                                <asp:Button ID="btnCheckAvailability" runat="server" Text="Check Availability" BackColor="#66CCFF"
